...
// Define custom props for ScrollArea to explicitly include viewportRef
...
>(({ className, children, viewportRef, ...props }, ref) => ( // Destructure viewportRef
  <ScrollAreaPrimitive.Root
    ...
    {...props} // props now doesn't have viewportRef
  >
    <ScrollAreaPrimitive.Viewport
      ref={viewportRef} // Apply viewportRef to the Viewport component
